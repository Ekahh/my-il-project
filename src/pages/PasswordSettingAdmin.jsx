      ...
      <div className="w-full md:w-1/4 bg-gray-100 p-5">
        <div className="flex flex-col space-y-4">
          ...
          <Link
            ...
            className="hover:bg-gray-200 transition-all duration-300 p-3 rounded cursor-pointer"
          >
            <img
              src={userIcon}
              alt="user"
          ...
          <Link
            ...
            className="hover:bg-gray-200 transition-all duration-300 p-3 rounded-md bg-white cursor-pointer"
          >
            <img
              src={lockIcon}
              alt="lock"
