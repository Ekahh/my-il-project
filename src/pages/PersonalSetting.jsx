    ...
    <div className="flex flex-col lg:flex-row h-screen w-screen overflow-hidden">
      ...
      <aside className="w-full lg:w-1/4 bg-green-100 p-4 sm:p-6">
        ...
        <ul className="mt-4 space-y-4">
          ...
          <li>
            <Link to="/view-setting" className="flex items-center space-x-2 p-2 rounded-md hover:bg-green-200 transition duration-300 ease-in-out cursor-pointer">
              <img src="./src/assets/paint-icon.svg" alt="Tampilan Icon" className="w-5 h-5" />
              <span>Tampilan</span>
            </Link>
          </li>
          <li>
            <Link to="#" className="flex items-center space-x-2 p-2 rounded-md hover:bg-green-200 transition duration-300 ease-in-out cursor-pointer">
